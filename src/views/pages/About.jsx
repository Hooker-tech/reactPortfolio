...
const About = () => {
  return (
    <section className="bg-[#fcf7ef] py-10">
      <div className="flex flex-wrap justify-center items-center gap-8 w-full max-w-[1200px] mx-auto">
        ...
        <div className="flex-1 max-w-[45%] text-left p-5 md:max-w-[80%]">
          <h1 className="text-[2.5em] text-[#5a5959] font-bold mb-3 md:text-[2em]">
            As A Developer
          </h1>
          <hr className="border-t-2 border-gray-400 mb-5" />
          <p className="text-[1.2em] leading-[1.6] text-[#5a5959] md:text-[1.1em] sm:text-[1em]">
